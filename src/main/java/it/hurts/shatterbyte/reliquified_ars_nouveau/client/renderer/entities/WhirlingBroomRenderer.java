package it.hurts.shatterbyte.reliquified_ars_nouveau.client.renderer.entities;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.math.Axis;
import it.hurts.shatterbyte.reliquified_ars_nouveau.ReliquifiedArsNouveau;
import it.hurts.shatterbyte.reliquified_ars_nouveau.client.models.entities.WhirlingBroomModel;
...
public class WhirlingBroomRenderer extends EntityRenderer<WhirlingBroomEntity> {
    ...
    @Override
    public void render(WhirlingBroomEntity broomEntity, float entityYaw, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        poseStack.pushPose();
        ...
        poseStack.translate(0.6, -0.1F, 0);

        var renderType = RenderType.entityTranslucent(ResourceLocation.fromNamespaceAndPath(ReliquifiedArsNouveau.MODID, "textures/entities/whirling_broom.png"));
